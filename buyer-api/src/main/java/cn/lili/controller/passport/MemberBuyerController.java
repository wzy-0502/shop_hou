...
public class MemberBuyerController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "badge", value = "工牌", required = true, paramType = "query")
    })
    ...
    public ResultMessage<Object> register(@NotNull(message = "用户名不能为空") @RequestParam String username,
                                          ...
                                          @NotNull(message = "工牌不能为空") @RequestParam String badge) {

        return ResultUtil.data(memberService.register(username, password, mobilePhone,badge));
